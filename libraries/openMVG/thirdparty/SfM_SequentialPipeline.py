...
foca = 1.2 * max(640, 480)
pIntrisics = subprocess.Popen( [os.path.join(OPENMVG_SFM_BIN, "openMVG_main_SfMInit_ImageListing"), "-f", str(foca), "-i", input_dir, "-o", matches_dir, "-d", camera_file_params] )
pIntrisics.wait()
