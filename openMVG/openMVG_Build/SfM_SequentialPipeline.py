...
OPENMVG_SFM_BIN = "/home/daniel/Desktop/openMVG/openMVG_Build/Linux-x86_64-RELEASE"

# Indicate the openMVG camera sensor width directory
CAMERA_SENSOR_WIDTH_DIRECTORY = "/home/daniel/Desktop/openMVG/src/software/SfM" + "/../../openMVG/exif/sensor_width_database"
...
if len(sys.argv) < 4:
    print ("Usage %s image_dir output_dir focal_length" % sys.argv[0])
    sys.exit(1)
